...
class nomina_electronica(models.Model):
    ...
    def on_change_employee(self):
        for record in self:
            generales = self.env['electronicos_nomina.datos_generales'].search([('name', '=', 'Nómina electrónica')])
    ...
    def envio_directo(self):
        ...
        valores = self.env['electronicos_nomina.datos_generales'].search([('name', '=', 'Nómina electrónica')])
